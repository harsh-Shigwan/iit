...
const BarChart = ({ wcpm, speechRate, pronScore, percentAttempt }) => {
    ...
    datasets: [
      {
        ...
        backgroundColor: "rgba(120, 149, 255, 1)", // Blue
      ...
      },
      {
        ...
        backgroundColor: "rgba(243, 221, 24, 1)", // Yellow
      ...
      },
      {
        ...
        backgroundColor: "rgba(253, 129, 156, 1)", // Pink
  ...
  const options = {
    ...
    plugins: {
      legend: { position: "top" },
      title: { display: true, text: "Speech Assessment Metrics (Scaled to 100%)" },
    },
    scales: {
      x: {
        grid: { display: false },
