...
import { Table, TableHead, TableBody, TableRow, TableCell, TableContainer, TablePagination, TableFooter } from "@mui/material";
...
const All_Students = () => {
  ...
  const { data: myData = [], isError, isLoading } = useQuery({
    queryKey: ["students"], // Query key as an array
    queryFn: async () => {
...
console.log("Cached Data:", queryClient.getQueryData(["students"]));
                              ...
                              <div className="flex bg-slate-40 w-24">
                                ...
                                <div className="relative bg-theme-primary-dark h-[52px]">
                                  <button
                                    ...
                                    onClick={() => deleteData(student.studentId)}
                                  >
