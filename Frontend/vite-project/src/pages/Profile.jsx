...
const Profile = () => {
  ...
  return (
    <div>
      ...
      <button className=" absolute left-[920px] top-[144px] flex gap-3 justify-end py-3 pr-2.5 text-2xl font-semibold leading-5 text-blue-600 whitespace-nowrap rounded-lg border border-blue-600 border-solid w-[45px]" onClick={handle}>
          <img
            loading="lazy"
